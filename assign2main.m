...
% Question 4
[rect_freq_vector, rect_time_vector, rect_magnitude_spectrogram] = mySpecgram(y, 2048, 2048, 44100, 'rect');
[hann_freq_vector, hann_time_vector, hann_magnitude_spectrogram] = mySpecgram(y, 2048, 2048, 44100, 'hann');
